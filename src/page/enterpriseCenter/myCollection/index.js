                ...
                >
                    ...
                    <Row>
                        ...
                        <Col span={16}>
                            ...
                            {record!=undefined ? <a className="model-button" href={record.declare_net.indexOf("http") == -1 ? "http://"+record.declare_net.trim() : record.declare_net} target="_blank">网上申报</a> : null}
                        </Col>
                    </Row> : null}
