...
class BusinessInformation extends Component {
    ...
    getDefaultData = async () => {
        ...
        if (industryData && industryData.success) {
            const register_address = tData.register_address != "" && tData.register_address ? tData.register_address.split(",") : null;
            this.getProvinceData();
            ...
            this.setState({
                ...
                register_address,
                set_up_value: tData.set_up_value
            }, () => {
                let strTime = tData.set_up_value;
                if (strTime) {
                    if (strTime == 200000) {
                        strTime += 1;
                    }
                    ...
                    tData.set_up_value = moment(strTime.substr(0, 4) + "-" + strTime.substr(4), 'YYYY-MM');
                }
                console.log(tData.json_data)
                this.props.form.setFieldsValue({...tData.json_data, ...tData});
            });
        ...
        this.props.form.validateFields(async (err, values) => {
            if (!err) {
                ...
                if (values) {
                    ...
                    values.industry_label_id = undefined;
                    values.set_up_value = undefined;
                    values.register_address = undefined;
                }
            ...
            <div className="b-information-template">
                ...
                <div className="information-form-box max-weight-box">
                    <Form ref="form" {...layout} name="nest-messages" onSubmit={this.onFinish}>
                        <Row>
                            <Col span={4}>
                                {id ? <PolicyManagementMenu current="enterprise"/> :
                                    <EnterpriseMenu menuKey="businessInformation"/>}

                            </Col>
                            <Col span={20}>
                                {id ? <div className="b-information-butn" style={{float: "right", marginTop: "30px"}}>
                                        <Button onClick={() => {
                                            this.props.history.goBack()
                                        }}>返回</Button></div> :
                                    <div className="b-information-butn" style={{float: "right", marginTop: "30px"}}>
                                        {isEdit ? <Button type="primary" icon="edit" className="button-edit"
                                                          onClick={this.setEdit}>编辑</Button> : null}
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {getFieldDecorator('set_up_value')(
                                                    <MonthPicker style={{width: "255px"}} disabled
                                                                 onChange={this.onChange} format="YYYY-MM"
                                                                 picker="month"/>
                                                )}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colSpan={5} className="address-box">
                                                {provinceSelect ? <Select disabled
                                                                          defaultValue={register_address ? parseInt(register_address[0]) : null}
                                                ...
                                                {getFieldDecorator('address')(
                                                    <Input disabled={isEdit} placeholder="街道"
